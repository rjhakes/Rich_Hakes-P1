...
namespace StoreTests
{
    public class ProductModelTest
    {
        ...
        {
            string testName = "zProduct";
            //Act
            testProduct.ProdName = testName;
            //Assert
            Assert.Equal(testName, testProduct.ProdName);
        }
        ...
        {
            //Act and Assert
            Assert.Throws<ArgumentNullException>(() => testProduct.ProdName = testName);
        }
